...
export default function Layout({ children }) {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white relative">
      ...
      {/* Tombol hamburger di mobile - Sticky */}
      <div className="md:hidden fixed top-0 left-0 w-full bg-gray-900 text-white px-4 py-3 z-40 flex justify-between items-center shadow-lg">
